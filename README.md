...
- **Skills Marquee:** A smooth, infinite-scrolling marquee highlighting core competencies.
- **Typewriter Effect:** Custom scroll-triggered typewriter animation in the contact section.
...
1. **Clone the repository**
   ```bash
   git clone https://github.com/preethu13/portfolio.git
   cd portfolio
   ```
...
2. **Install dependencies**
   ...
   ```
   *(Note: `--legacy-peer-deps` is required due to TanStack Router configuration dependencies)*
...
- LinkedIn: [contactpreethamdsouza](https://www.linkedin.com/in/contactpreethamdsouza)
- GitHub: [@preethu13](https://github.com/preethu13)

---
*Hand-crafted, no templates.*
